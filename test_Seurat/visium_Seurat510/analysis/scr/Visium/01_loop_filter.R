...
# sample_id <- dir("../data/misc/test_edo/filtered/") %>%
...
#   path_in <- paste0("../data/misc/test_edo/filtered/sample_",samp,"/",samp,"_filtered_count_matrix/")
#   path_out <- paste0("../data/misc/test_edo/filtered/sample_",samp,"/",samp,".h5")
# 
...
list_sobj <- lapply(sample_id,function(samp){
  ...
  # define the paths in input and output
  path_in_image <- paste0("../data/misc/test_edo/filtered/sample_",samp,"/",samp,"_spatial/")
  path_in_reads <- paste0("../data/misc/test_edo/filtered/sample_",samp,"/")
  sample_h5 <- paste0(samp,".h5")
  path_in_meta <- paste0("../data/misc/test_edo/filtered/sample_",samp,"/",samp,"_metadata.csv")
...
saveRDS(list_sobj,file = "../out/object/list_spobj_filtered.rds")
...
pdf("../out/plot/01_plot_filtered.pdf",width = 22,height = 20)
